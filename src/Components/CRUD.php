...
use Xbcode\Builder\Components\Table\Table;
 ...
 * @method $this api(string $value) 设置 CRUD 用来获取列表数据的 api
 ...
 * @method $this quickSaveApi(string $value) 快速编辑后用来批量保存的 API
 * @method $this quickSaveItemApi(string $value) 快速编辑配置成及时保存时使用的 API
