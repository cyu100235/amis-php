...
use Xbcode\Builder\Renders\Grid\Curd\GridColumn;
use Xbcode\Builder\Renders\Grid\Curd\GridFilter;
use Xbcode\Builder\Renders\Grid\Curd\GridFooter;
use Xbcode\Builder\Renders\Grid\Curd\GridQuickEdit;
use Xbcode\Builder\Renders\Grid\Curd\GridToolbar;
use Xbcode\Builder\Renders\Grid\Curd\GridActionButtons;
...
trait GridCurd
{
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function initCRUD(string $api, string $title = '数据列表')
    {
        // 页面标题
        $this->usePage()->title($title);
        // 表格数据源
        $this->useCRUD()->api($api);
        // 是否将筛选查询的参数同步到地址栏
