...
use Xbcode\Builder\Components\Action\DownloadAction;
...
trait BulkAction
{
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionAjax(string $url, string $title, callable|array $option = null): AjaxAction
    {
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionConfirm(string $url, string $title, callable|array $option = null): AjaxAction
    {
        $component = new AjaxAction;
        $component->api($url);
        $component->label($title);
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionDialog(string $url, string $title, callable|array $option = null): DialogAction
    {
        /** @var DialogAction */
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionDownload(string $url, string $title, callable|array $option = null): DownloadAction
    {
        /** @var DownloadAction */
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionDrawer(string $url, string $title, callable|array $option = null): DrawerAction
    {
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionLink(string $url, string $title, callable|array $option = null): LinkAction
    {
     ...
     * @author 楚羽幽 958416459@qq.com
     */
    public function addBulkActionUrl(string $url, string $title, callable|array $option = null): UrlAction
    {
